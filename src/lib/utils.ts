export const HOSTING_CONFIG_KEY = 'homify_hosting_config'
export const HOSTING_DOMAIN_SUFFIX = '.homify.app'
...
export const createHostingSlug = () =>
    `homify-${Date.now().toString(36)}-${Math.random().toString(36).slice(2, 8)}`
